...
const SideBar = ({ children }: any) => {
    ...
    const whatIcon = (nome: any) => {
        switch (nome) {
            case 'Home':
                return <svg width="35" height="35" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return <>
        <div className="grid grid-rows-1 grid-cols-12 h-screen w-screen transition-all">
            <div className={toggles ? "w-full h-full  col-span-1 shadow-2xl border-r flex flex-col justify-between border-gray-100 p-2" : "w-full h-full  col-span-2 shadow-2xl border-r flex flex-col justify-between border-gray-100 p-2"}>
                    ...
                    {toggles ?
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="flex justify-center ">
                                <button className=" rounded-3xl   text-verdeBase hover:bg-verdeBase hover:text-white transition-all" onClick={() => setToggleS(!toggles)}>{toggles ? <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="flex justify-between bg-white rounded-xl p-1 gap-2">
                                    <div className=" flex items-center ">
                                        ...
                                        <div className="text-xs">
                                            ...
                                            <p className="text-gray-700 text-ellipsis overflow-hidden ... w-[130PX]">
                                                {email}
                                            </p>
                                        </div>
                                    </div>
            ...
            <div className={toggles ? "w-full h-full col-start-2 col-end-13 bg-gray-50 shadow-inner overflow-auto scroll" : "w-full h-full col-start-3 col-end-13 bg-gray-50 shadow-inner overflow-auto scroll"}>
                {children}
            </div>
